                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('product') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="brand_id" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}">
                                 <option>Please Choose</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="price" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="quantity" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="description" value="{{ old('name') }}" required autofocus>
